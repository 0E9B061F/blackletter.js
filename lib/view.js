...
class ViewInstance {
  ...
  construct() {
    ...
    console.log(`this.view.construct a: ${this.view.construct}`)
    if (this.view.construct) {
      console.log(`this.view.construct b: ${this.view.construct}`)
      this.view.construct.call(this, ...this.conf.args)
    }
...
class View {
  constructor(app, name, ls, handler, conf) {
    ...
    this.construct = this.conf.construct
